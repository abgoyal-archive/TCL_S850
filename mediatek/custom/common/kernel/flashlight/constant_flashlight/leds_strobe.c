...
#define LED_CURRENT				0x80<<0	//800mA
#define LED_CURRENT_LOW			0x20<<0	//200mA

#define REGISTER_TXMASK 			0x03
#define EXT_TORCH_ON				0x10<<0
#define COIL_PEAK					0x01<<2
#define FLASH_TXMASK_CURRENT	0x04<<4  //400mA
...
static u8 led_current=LED_CURRENT;
...
static int constant_flashlight_ioctl(MUINT32 cmd, MUINT32 arg)
{
    ...
    switch(cmd)
    {
        ...
        case FLASHLIGHTIOC_T_LEVEL:
	    	...
	    	printk("FLASHLIGHTIOC_T_LEVEL: arg=%d \n",(int)arg);		
